// Package apptrace provides a Go app performance tracing suite.
//
// Apptrace allows you to trace the end-to-end performance of hierarchically
...
// Web Front-end
//
// The cmd/apptrace tool launches a web front-end which displays a web UI for
...
// utilizing the traceapp sub-package, which is effectively what cmd/apptrace
// serves internally.
//
// HTTP and SQL tracing
//
// Sub-packages for HTTP and SQL event tracing are provided for use with
// apptrace, which allows it to function equivalently to Google's Dapper and
...
// or time-stamped events (the cmd/apptrace web UI displays these events as
// appropriate).
//
