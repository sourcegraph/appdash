...
//go:generate go-bindata -tags=!dev -ignore=.*\.go -pkg=tmpl -prefix=$GOPATH/src/sourcegraph.com/sourcegraph/appdash/traceapp/tmpl -o traceapp/tmpl/data.go traceapp/tmpl/...
//go:generate go-bindata -dev -tags=dev -ignore=.*\.go -pkg=tmpl -prefix=$GOPATH/src/sourcegraph.com/sourcegraph/appdash/traceapp/tmpl -o traceapp/tmpl/data_src.go traceapp/tmpl/...
//go:generate go fmt ./...
