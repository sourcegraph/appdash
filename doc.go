...
//go:generate go-bindata -tags=!debug -ignore=.*\.go -pkg=tmpl -prefix=$GOPATH/src/sourcegraph.com/sourcegraph/appdash/traceapp/tmpl -o traceapp/tmpl/data.go traceapp/tmpl/...
//go:generate go-bindata -debug -tags=debug -ignore=.*\.go -pkg=tmpl -prefix=$GOPATH/src/sourcegraph.com/sourcegraph/appdash/traceapp/tmpl -o traceapp/tmpl/data_src.go traceapp/tmpl/...
//go:generate go fmt ./...
